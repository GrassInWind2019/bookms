-- SELECT * FROM bookms.bookms_user_favorite;
-- select count(*) from bookms_user_favorite;
-- select * from bookms_book b inner join (select identify from bookms_user_favorite where user_id=1 limit 10 offset 2000) as bk_fav using(identify);
use bookms;
